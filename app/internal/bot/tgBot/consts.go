...
const (
	// Messages
	wellcomeMessage = `
	Поздравляю! Вы успешно зарегистрировались в BoostMySkillsBot. 
	...
	⚠️И всё❔
	Нет, в ближаейшее время будет добавлен следующий функционал:
	1. Можно будет получать вопросы от бота каэдые n минут. То есть один раз указали время 40 мин и бот будет присылать вам вопросы каждые 40 мин.
	2. Можно будет выбирать сложность вопросов.
	`
